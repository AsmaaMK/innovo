...
$(document).ready(function () {
  ...
  (function ($) {
    if (
      !$(".off-canvas-wrapper-left").length &&
      !$(".off-canvas-wrapper-right").length
    )
      return;
    ...
    function closeOffCanvas() {
      ...
      scrollTop !== 0
        ? (scrollTopOldValue = scrollTop)
        : (scrollTop = scrollTopOldValue);
    ...
    $("body").append(
      $("<div />").addClass("click-close-off-canvas off-canvas-overlay")
    );

    $(".click-btn-off-canvas-left")
      .off("dbclick")
      .on("click", function () {
  ...
  (function ($) {
    ...
    $("#home-1-testimonial-slider .gallery-main").slick({
      ...
      appendArrows:
        "#home-1-testimonial-slider .slick-slide-control .group-inner",
      nextArrow:
        '<button type="button" class="mv-btn mv-btn-style-3 slick-slide-next"><i class="fa fa-angle-right"></i></button>',
      prevArrow:
        '<button type="button" class="mv-btn mv-btn-style-3 slick-slide-prev"><i class="fa fa-angle-left"></i></button>',
      slidesToShow: 1,
      slidesToScroll: 1,
      autoplay: true,
      autoplaySpeed: 6000,
  ...
  (function ($) {
    ...
    var swiper = new Swiper(
      "#home-3-new-trending-item-slider .swiper-container",
      {
  ...
  /* --------------------------------------------------------------------- */
  (function ($) {
    if (!$("#home-5-what-hots-slider").length) return;

    $("#home-5-what-hots-slider .mv-slider-wrapper").carouFredSel({
      infinite: true,
      circular: true,
      responsive: true,
      debug: false,
      ...
      prev: {
        button: "#home-5-what-hots-slider-prev",
      },

      next: {
        button: "#home-5-what-hots-slider-next",
      },
    });
  })(jQuery);
  ...
  /* --------------------------------------------------------------------- */
  (function ($) {
    if (!$("#home-6-what-hots-slider").length) return;

    $("#home-6-what-hots-slider .mv-slider-wrapper").carouFredSel({
      infinite: true,
      circular: true,
      responsive: true,
      debug: false,
      ...
      prev: {
        button: "#home-6-what-hots-slider-prev",
      },

      next: {
        button: "#home-6-what-hots-slider-next",
      },
    });
  })(jQuery);
  ...
  /* --------------------------------------------------------------------- */
  (function ($) {
    if (!$("#home-7-what-hots-slider").length) return;

    $("#home-7-what-hots-slider .mv-slider-wrapper").carouFredSel({
      infinite: true,
      circular: true,
      responsive: true,
      debug: false,
      ...
      prev: {
        button: "#home-7-what-hots-slider-prev",
      },

      next: {
        button: "#home-7-what-hots-slider-next",
      },
    });
  })(jQuery);
  ...
  (function ($) {
    ...
    $(document.body).on(
      "click",
      ".mv-rate.enabled-rating .item-rate",
      function () {
        $(this)
          .closest(".mv-rate.enabled-rating")
          .find(".item-rate")
          .removeClass("rate-on rated");
        $(this).prevAll().andSelf().addClass("rate-on rated");
        console.log($(this).index() + 1);
        $(this)
          .closest(".mv-rate")
          .find(".input-score-rate")
          .val($(this).index() + 1);
        printText($(this));
      }
    );
  ...
  (function ($) {
    ...
    $(window).on("scroll", function () {
      $(this).scrollTop() > 220
        ? $(".mv-back-to-top").addClass("on")
        : $(".mv-back-to-top").removeClass("on");
    });
  ...
  (function ($) {
    ...
    $(".product-detail-slider .gallery-thumbs").slick({
      ...
      nextArrow:
        '<button type="button" class="mv-btn mv-btn-style-7 slick-slide-next"><i class="fa fa-angle-right"></i></button>',
      prevArrow:
        '<button type="button" class="mv-btn mv-btn-style-7 slick-slide-prev"><i class="fa fa-angle-left"></i></button>',
      slidesToShow: 5,
      slidesToScroll: 1,
      infinite: false,
      arrows: true,
  ...
  (function ($) {
    ...
    var mapInfoBox =
      ...
      "," +
      longitude +
      '", target="_blank" class="icon-home">' +
      '<i class="fa fa-home mv-f-50"></i>' +
      "</a>" +
      "</div>" +
    ...
    function mapInitialize() {
      ...
      var map = new google.maps.Map(
        document.getElementById("mv-map-canvas"),
        mapOptions
      );
  ...
  (function ($) {
    ...
    $(document.body)
      ...
      .on("click", ".btn-add-to-cart", function () {
        ...
        var htmlString =
          '<i class="fa fa-check mv-color-primary"></i> 1 item added to cart. <a href="cart.html"><strong>View cart</strong></a>';
  ...
  (function ($) {
    ...
    $(document.body)
      ...
      .on("click", ".btn-add-to-wishlist", function () {
        ...
        var messageAction = post.find(".content-message .message-inner");
        var htmlString =
          '<i class="fa fa-check mv-color-primary"></i> 1 item added to wishlist. <a href="wishlist.html"><strong>View wishlist</strong></a>';
  ...
  (function ($) {
    ...
    $(".btn-choose-method")
      ...
      .on("click", function () {
        ...
        $(this)
          .closest(".method-payment-list")
          .find(".item")
          .removeClass("active");
        $(this)
          .closest(".method-payment-list")
          .find('.radio-list input[type="radio"]')
          .prop("checked", false);

        if (!thisItem.hasClass("active")) {
          thisItem.addClass("active");
          thisItem
            .find(".radio-list .radio-children")
            .eq(0)
    ...
    $('.method-payment-list .radio-list input[type="radio"]').on(
      "change",
      function () {
